...
Neste artigo, exploro como essa abordagem funciona na prática, usando Terraform para criar monitores no Datadog. Desde a configuração do ambiente até boas práticas para organização do código, passando por exemplos práticos e dicas para brilhar no próximo incidente em produção (ou melhor, preveni-lo).
...
Antes de começar, é preciso garantir que o terreno está preparado. Afinal, criar monitores como código sem uma base bem configurada é como tentar construir um arranha-céu sem fundação.

### Ferramentas Necessárias

Você vai precisar de três coisas principais:
1. **Terraform**: O orquestrador das configurações.
...
### Customizando Thresholds e Notificações
